namespace FinalSub
{
    ...
    public class Trie
    {
        ...
        public bool InsertPhrase(string phrase)
        {
            ...
            if (!IsPhraseAlphabeticalOnly(phrase))
            {
                return false;
            }
        ...
        public List<string> SearchPhrasesForPrefix(string prefix)
        {
            ...
            if (!IsPhraseAlphabeticalOnly(prefix))
            {
        ...
        private bool IsPhraseAlphabeticalOnly(string phrase)
        {
            // Limit the number of result length to 2 words only
            if (phrase.Split('_').Length > maxWordNum)
            {
                return false;
            }
